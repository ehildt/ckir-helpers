...
- f21c853: fix: add prettier as a direct devDependency so `changeset version` can format the CHANGELOG in CI (pnpm 10 does not link binaries of auto-installed peer dependencies into `node_modules/.bin`)
